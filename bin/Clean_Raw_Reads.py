...
for i in range(0,len(fastq_files),2):
    ...
    # Output Files
    OF1 = "Trimmed_Fastq_Files/" + fastq_files[i].split(".")[0] + "_Trimmed.fastq" 
    OF2 = "Trimmed_Fastq_Files/" + fastq_files[i+1].split(".")[0] + "_Trimmed.fastq"
    log_file = "Trimmed_Fastq_Files/" + fastq_files[i] + ".log"
    
    print ("Executing bbduk for..", fastq_files[i],"\t",fastq_files[i+1],"\n")
