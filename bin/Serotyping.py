...
execute_seqsero = seqsero_location + "SeqSero.py -m 1 -i " + fastq_location +  INF1 + " -b mem >" + OF1
os.system(execute_seqsero)

execute_seqsero = seqsero_location + "SeqSero.py -m 1 -i " + fastq_location + INF2 + " -b mem >" + OF2
os.system(execute_seqsero)