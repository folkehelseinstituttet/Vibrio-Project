...
ref_genome = config['BASIC']['REF_GENOME_VibrioVulnificus']
...
execute_parsnp = parsnp_location + "parsnp -c -r " + ref_genome + " -d " + assembly_location + " -o " + phylogenetics_reports + " -p 8"
