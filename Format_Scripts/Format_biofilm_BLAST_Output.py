...
def format_filter(f,l,GID_Des):
    ...
    for i in F1:
        ...
        if float(temp[2]) >= identity and gene_prop >= gene_length:
            ...
            print (f,",",temp[0],",",temp[1],",",temp[2],",",temp[3],",",GID_Des[temp[1]].strip())
...
###################### Main Script ###################################
######################################################################
file_location = "/cluster/home/jeevka/2019_Oct_Vibrio/Biofilmes_Out/"
...
for i in blast_output_files:
    format_filter(i,file_location,GID_Des)
